"""Differentiable rasterization for RGB and multispectral Gaussian points."""

import torch
import taichi as ti
from ..common.Camera import CameraInfo
from ..common.utils import (
    taichi_inverse_SE3, inverse_SE3_qt_torch,
    ...
    rotation_matrix_to_quaternion_torch, quaternion_to_rotation_matrix_torch,
    SE3_to_quaternion_and_translation_torch,
    transform_matrix_from_quaternion_and_translation_torch, inverse_SE3)
from .GaussianPoint3D import (
    GaussianPoint3D, project_point_to_camera, transform_matrix_from_quaternion_and_translation)
from ..common.SphericalHarmonics import vec16f
from ..common.rasterization import (
    BOUNDARY_TILES, TILE_HEIGHT, TILE_WIDTH,
    allocate_memory_for_filter_points,
    allocate_memory_for_rendered_images,
    calculate_tiles_start_and_end,
...
import cv2
import math
from .rasterization_types import (
    BackwardValidPointHookInput,
    GaussianPointCloudRasterisationConfig,
    GaussianPointCloudRasterisationInput,
)
...
class GaussianPointCloudRasterisation(torch.nn.Module):
    GaussianPointCloudRasterisationConfig = GaussianPointCloudRasterisationConfig
    GaussianPointCloudRasterisationInput = GaussianPointCloudRasterisationInput
    BackwardValidPointHookInput = BackwardValidPointHookInput
    ...
    def __init__(
        ...
        class RGBRasterizationFunction(torch.autograd.Function):
        ...
        # for validation
        class AllModalitiesValidationFunction(torch.autograd.Function):
        ...
        # for validation
        class SingleModalityValidationFunction(torch.autograd.Function):
        ...
        # for MS optimization
        class MultispectralRasterizationFunction(torch.autograd.Function):
        ...
        class PoseInitializationFunction(torch.autograd.Function):
            ...
            def forward(ctx,
                ...
                _, vector_rotation, vector_translation = cv2.solvePnP(
        ...
        self._module_function = RGBRasterizationFunction
        self._module_function_validation = SingleModalityValidationFunction
        self._module_function_ms_only = MultispectralRasterizationFunction
        self._module_function_pose_initialize = PoseInitializationFunction
        self._module_function_val_all = AllModalitiesValidationFunction
    ...
    def forward(self, input_data: GaussianPointCloudRasterisationInput, current_train_stage: str, reference_ms_image=None):
        ...
        if current_train_stage in ('s1', 'ending_RGB'):
        ...
        if current_train_stage in ('s2p2', 's2p3', 'ending_MS'):
