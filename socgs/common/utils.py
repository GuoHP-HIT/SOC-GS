...
def rotation_matrix_to_quaternion_torch(
    ...
    q = torch.zeros(1, 4, device=R.device,
    ...
    if q0_mask.any():
        ...
        q[0, 3] = 0.25 / S_for_q0
        q[0, 0] = (R_for_q0[..., 2, 1] - R_for_q0[..., 1, 2]) * S_for_q0
        q[0, 1] = (R_for_q0[..., 0, 2] - R_for_q0[..., 2, 0]) * S_for_q0
        q[0, 2] = (R_for_q0[..., 1, 0] - R_for_q0[..., 0, 1]) * S_for_q0
    ...
    if q1_mask.any():
        ...
        q[0, 0] = 0.25 * S_for_q1
        q[0, 1] = (R_for_q1[..., 0, 1] + R_for_q1[..., 1, 0]) / S_for_q1
        q[0, 2] = (R_for_q1[..., 0, 2] + R_for_q1[..., 2, 0]) / S_for_q1
        q[0, 3] = (R_for_q1[..., 2, 1] - R_for_q1[..., 1, 2]) / S_for_q1
    ...
    if q2_mask.any():
        ...
        q[0, 0] = (R_for_q2[..., 0, 1] + R_for_q2[..., 1, 0]) / S_for_q2
        q[0, 1] = 0.25 * S_for_q2
        q[0, 2] = (R_for_q2[..., 1, 2] + R_for_q2[..., 2, 1]) / S_for_q2
        q[0, 3] = (R_for_q2[..., 0, 2] - R_for_q2[..., 2, 0]) / S_for_q2
    ...
    if q3_mask.any():
        ...
        q[0, 0] = (R_for_q3[..., 0, 2] + R_for_q3[..., 2, 0]) / S_for_q3
        q[0, 1] = (R_for_q3[..., 1, 2] + R_for_q3[..., 2, 1]) / S_for_q3
        q[0, 2] = 0.25 * S_for_q3
        q[0, 3] = (R_for_q3[..., 1, 0] - R_for_q3[..., 0, 1]) / S_for_q3
    return q
...
def transform_matrix_from_quaternion_and_translation_torch(q, t):
    ...
    """
    R = rotation_matrix_from_quaternion_torch(q)
    return torch.tensor([
...
def rotation_matrix_from_quaternion_torch(q):
    """
...
def torch_inverse_SE3(transform):
    R_T = torch.tensor([
        [transform[0, 0], transform[1, 0], transform[2, 0]],
        [transform[0, 1], transform[1, 1], transform[2, 1]],
        [transform[0, 2], transform[1, 2], transform[2, 2]]
    ], device=transform.device)
    t = torch.tensor([transform[0, 3], transform[1, 3], transform[2, 3]], device=transform.device)
    inverse_transform_t = -R_T @ t
