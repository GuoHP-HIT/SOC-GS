"""Differentiable rasterization for RGB, infrared, and multispectral Gaussian points."""
...
class GaussianPointCloudRasterisation(torch.nn.Module):
    ...
    def __init__(
        ...
        # for MS optimization
        class InfraredRasterizationFunction(torch.autograd.Function):
        ...
        class PoseInitializationFunction(torch.autograd.Function):
            ...
            def forward(ctx,
                ...
                _, vector_rotation, vector_translation, _ = cv2.solvePnPRansac(
        ...
        self._module_function_validation = AllModalitiesValidationFunction
        self._module_function_ms_only = MultispectralRasterizationFunction
        self._module_function_ir_only = InfraredRasterizationFunction
    ...
    def forward(self, input_data: GaussianPointCloudRasterisationInput, current_train_stage: str, reference_ms_image=None):
        ...
        if current_train_stage in ('s1', 'ending_rgb', 'val_RGB'):
        ...
        if current_train_stage in ('s2p2_ms', 's2p3_ms', 'val_MS', 'ending_ms'):
        ...
        if current_train_stage in ('s2p2_ir', 's2p3_ir', 'val_IR', 'ending_ir'):
